 ...
 ?>
      <nav>
        <ul>
          ...
          <table border="0px">
            ...
            <td><li style="float:right"><a class="active"href="#">Carian</a></li></td>
  ...
  <section id="hero">
      ...
      <center>
       <table id="tablecss">
         <tr>
           <td><center><button class="button" style="vertical-align:middle"><a href="carianTarikh.php"><span>Berdasarkan Tahun</a></span></button></td>
           <td><center><button class="button" style="vertical-align:middle"><a href="carianIdStaff.php"><span>Berdasarkan Nombor Pekerja</a></span></button></td>
         </tr>
       </table>
     </center>
