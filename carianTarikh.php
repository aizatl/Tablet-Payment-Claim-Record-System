...
$username = $_SESSION['username'];//terima
 ...
 <ul>
   ...
   <table border="0px">
     ...
     <td><li style="float:right"><a class="active"href="#">Carian Tahun</a></li></td>
  ...
  <section id="hero">
    ...
    <div class="hero-container">
      <div>
        <center>
        <h1>Carian Mengikut Tahun</h1>
        <form class="" action="carianTarikh.php" method="post">
          <input type="text" id="tahunDicari" placeholder="Masukkan tahun" name="tahunDicari">
          <input type="submit" name = "cari" value="Cari">
        </form>
        <br><br>
        <?php
        if(isset($_POST["cari"])){
          $tahunDicari=$_POST['tahunDicari']; //terima
          $info = getPurchasebyYear($tahunDicari);
          $wujud = checkWujudTahun($tahunDicari);
         ?>
        <?php
        ...
        if( $kira >0 && $wujud ==true){
          ...
          echo "<h1 class = 'mesej'>Tiada pembelian dibuat pada tahun ".$tahunDicari." ";
        }
        else if($wujud ==false){
          echo "<h1 class = 'mesej'>Tiada pembelian dibuat pada tahun ".$tahunDicari." ";
        }
